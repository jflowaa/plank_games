defmodule PlankGamesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlankGamesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlankGamesWeb.Gettext, "errors", msg, opts)
    end
  end
